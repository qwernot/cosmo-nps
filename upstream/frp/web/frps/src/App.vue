<template>
  <LoginView
    v-if="sessionChecked && !session"
    @logged-in="handleLoggedIn"
  />
  <div v-else-if="session" id="app">
    <header class="header">
      <div class="header-content">
        ...
        <div class="header-controls">
          <span class="session-user">{{ session.name }}</span>
...
import { clearBasicAuth } from './api/http'
...
const handleLoggedIn = (value: SessionInfo) => {
  session.value = value
}
